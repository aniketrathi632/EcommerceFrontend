...
import { ThemeStyle } from "../Utility/ThemeContext.jsx";
...
const Signup = () => {
  ...
  let lightTheme = "flex items-center justify-center min-h-[92vh] bg-[#cbd5e1]";
  let darkTheme = "flex items-center justify-center min-h-[92vh] bg-[#0f172a]";
