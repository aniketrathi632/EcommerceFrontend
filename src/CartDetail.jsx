        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
            ...
            <div className="h-96  border-2 border-white text-2xl ">
                ...
                <p className="flex justify-between flex-row my-4 mx-2 border-t-4 border-white relative top-32 "> <span>Total Amount  </span> <span> ${ (totalPrice -(totalPrice * 0.05)).toFixed(2)} </span></p>
            </div> 
