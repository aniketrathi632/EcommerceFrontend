...
const Login= () => {    
  ...
  let lightTheme = "h-[92vh] flex items-center justify-center w-full bg-[#cbd5e1] ";
  let darkTheme =
    "h-[92vh] flex items-center justify-center w-full bg-[#0f172a]";
  ...
  return (
    <div className={theme == "light" ? lightTheme : darkTheme}>
      <div className="bg-gray-200 shadow-md rounded-lg px-6 py-4 w-1/4 h-auto">
      <header>
